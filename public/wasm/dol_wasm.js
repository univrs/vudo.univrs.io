...
export function compile_dol(source) {
    ...
    const ret = wasm.compile_dol(ptr0, len0);
    if (ret[2]) {
...
export function format_dol(source) {
    ...
    try {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.format_dol(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
export function validate_dol(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_dol(ptr0, len0);
    return ret !== 0;
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('dol_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
